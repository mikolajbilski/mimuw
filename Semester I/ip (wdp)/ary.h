...
typedef struct wartosc { //niepoprawna wartosc oznaczamy jako [nan;nan] i is_antirange = false
  double lo, hi;
  //jesli true - przedzial to [-HUGE_VAL;lo] U [hi;+HUGE_VAL], w przeciwnym wypadku przedział to [lo;hi]
  bool is_antirange;
  } wartosc;
